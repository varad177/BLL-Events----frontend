...
const ViesAttendees = () => {
    ...
    const getAllUser = () => {
        ...
        api
            .post("/get-all-passUser", { search: search.search, page: currentPage, status: true })
            .then((res) => {
                                        ...
                                        <tr>
                                            ...
                                            <td colSpan={7} className="border px-2 py-2">
                                                <AnimationWrapper transition={{ duration: 1, delay: i * 0.1 }}>
                                                    ...
                                                    <br></br> <p className="font-bold inline-block">Status:{" "} </p>{user.status == true ? "Checked In" : "Yet To Arrived"} <br></br>
